...
public interface Constant {
    public static final String[] NEWS_TYPE_ARRAY = {"动画情报", "漫画情报", "影视化情报", "游戏情报",
            "周边资讯", "漫展资讯", "其他情报"};
    public static final String ERR404 = "/error/err404";
    public static final String ERR403 = "/error/err403";
//    public static final String SYSTEM_DISK="";
    public static final String SYSTEM_DISK="D:";
    public static final String UPLOAD_PATH = SYSTEM_DISK+"/allBlue";
    public static final String UPLOAD_TEMP_PATH = SYSTEM_DISK+"/temp/allBlue";
